...
- ovasCConfigurationtestEEGAcquisition.h
- ovasCConfigurationtestEEGAcquisition.cpp
- ovasCDrivertestEEGAcquisition.h
- ovasCDrivertestEEGAcquisition.cpp
You can put these files here in your local repository:
     [openvibe-repository]/contrib/plugins/server-drivers/[my-device]/src/

The glade interface:
- interface-testEEGAcquisition.glade
